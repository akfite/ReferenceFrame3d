    ...
    methods
        ...
        function plot(this, opts)
            ...
            if ~isempty(this.h_plot_group) ...
                    && isvalid(this.h_plot_group) ...
                    && isequal(this.h_plot_group.Parent, tform)
            ...
            this.h_plot_group = hggroup('Parent', tform, 'Tag', 'RF3D_BASIS_GROUP');
            ...
            for i = 1:3
                if opts.EnableArrowheads(i)
                    plot_arrowhead(this.h_plot_group, sz(i), opts.Colors(i), i);
                end
            end
            line(this.h_plot_group, ...
